...
FROM '/Users/urvi/Downloads/organizations-10000.csv'
...
-- Optional: Drop the original table and rename the new one
...
-- Step 17:
-- Add the New Column firm_size
ALTER TABLE organizations
ADD COLUMN firm_size VARCHAR(10);

-- Populate the firm_size Column
UPDATE organizations
SET firm_size = CASE
